    ...
    <div className="clubcard_parent">
      ...
      <div className="clubcard_top">
        ...
        <div className="clubcard_text">
          ...
          <p title={club?.description} aria-live="polite">
            {club?.description ||
      ...
      <div className="clubcard_ctadiv">
        <div className="profile_numbers">
          <p className="counts followersCount" aria-label={`1.25k ${t("followers")}`}>
            <span>1.25k</span> {t("followers")}
          </p>

          <p className="counts EventsCount" aria-label={`231 ${t("events")}`}>
